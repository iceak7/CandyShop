...
namespace CandyShop.Models
{
    public class ShoppingCart
    {
        ...
        {
            var ShoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(c=>c.Candy.CandyId==candy.CandyId && c.ShoppingCartId == ShoppingCartID);
        ...
        {
            var count = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartID).Select(c => c.Amount).Sum();
            return count;
        }
    }
}
