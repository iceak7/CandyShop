...
namespace CandyShop.Models
{
    public class AppDbContext: IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 1, CategoryName = "Chocolate Candy", CategoryDescription = "" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 2, CategoryName = "Fruit Candy", CategoryDescription = "" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 3, CategoryName = "Gummy Candy", CategoryDescription = "" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 4, CategoryName = "Halloween Candy Candy", CategoryDescription = "" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 5, CategoryName = "Hard Candy", CategoryDescription = "" });

            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                CandyId=1,
                Name="Assorted Chocolate Candy",
                Description= "elit duis tristique sollicitudin nibh sit amet commodo nulla facilisi",
