...
namespace CandyShop.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public RedirectToActionResult AddToShoppingCart(int candyId,string fromcontroller, string category)
        {
            ...
            if(fromcontroller == "list")
            {
                return RedirectToAction("List", "Candy", new { category });
            }
            else if (fromcontroller == "list-all")
            {
                return RedirectToAction("List", "Candy");
            }
            else if (fromcontroller == "home")
            {
